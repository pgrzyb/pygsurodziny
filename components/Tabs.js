    ...
    this.state = {
      days: [
        ...
        },  
        {
          ...
          intro: 'W prawdzie nie będziesz już co chwilę nazywana Królową, ale i bez tego ciąg dalszy kampanii jest ultra zajebiaszczy :D PROTOSI TEŻ CHCĄ BYĆ KOCHANI!!! <br /> Kodzix: <strong class="text-white">XXXX-XXXX-XXXX-XXXX</strong>',
          svg: `<svg class="w-12 h-12" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
