    ...
    this.state = {
      days: [
        ...
        },  
        {
          ...
          intro: 'W prawdzie nie będziesz już co chwilę nazywana Królową, ale i bez tego ciąg dalszy kampanii jest ultra zajebiaszczy :D PROTOSI TEŻ CHCĄ BYĆ KOCHANI!!! <br /> Kodzix: <strong class="text-white">KBHKT2-TCFZ-BZN6GY-2CND-Z7GD2W</strong>',
          svg: `<svg class="w-12 h-12" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                    ...
                    <Countdown date={date} className='text-xl font-bold'>
                      <div>                      
                        ...
                        <p class="leading-relaxed" dangerouslySetInnerHTML={{__html: day.intro}}>
                        </p>
                      </div>
                    </Countdown>
                  </div>
